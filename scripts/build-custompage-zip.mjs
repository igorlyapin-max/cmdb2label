...
const sourcePath = path.resolve('src/CmdbLabels.js');
const outputPath = path.resolve('dist/cmdblabels-custompage.zip');
const zipEntryName = 'CmdbLabels.js';
...
function buildZip(entryName, content, modifiedAt) {
  ...
  return Buffer.concat([localHeader, fileName, content, centralHeader, fileName, end]);
}
